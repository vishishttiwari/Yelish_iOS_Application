...
{
    return [self initWithQuality:AVCaptureSessionPresetLow position:LLCameraPositionRear videoEnabled:videoEnabled];
}
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder
{
    if (self = [super initWithCoder:aDecoder]) {
        [self setupWithQuality:AVCaptureSessionPresetLow
